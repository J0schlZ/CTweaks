        ...
        switch (args[0]) {
	    	case "enable": {
	    		...
	    		if (args.length > 1 && args[1].equalsIgnoreCase("commandblock")) {
	    			...
	    			p.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6Befehlsbl�cke &aaktiviert."));
	    		}
	    		break;
	    	}
	    	...
	    	case "disable": {
	    		...
	    		if (args.length > 1 && args[1].equalsIgnoreCase("commandblock")) {
	    			...
	    			p.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6Befehlsbl�cke &cdeaktiviert."));
	    		}
	    		break;
	    	}
